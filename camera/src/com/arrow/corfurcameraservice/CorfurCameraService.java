...
package com.arrow.corfurcameraservice;
...
public class CorfurCameraService extends Service {

    private static final boolean DEBUG = false;
    private static final String TAG = "CorfurCameraService";
    ...
    public static void startService(Context context) {
        ...
        context.startServiceAsUser(new Intent(context, CorfurCameraService.class),
                UserHandle.CURRENT);
    }
